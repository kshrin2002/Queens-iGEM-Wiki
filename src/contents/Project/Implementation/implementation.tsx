...
const CardSection: React.FC = () => {
  ...
  return (
    <Container fluid className="card-container-implementation">
      {sections.map((section, sectionIndex) => (
        <Card key={sectionIndex} className="custom-card-implementation" id={`section-${sectionIndex}`}>
          <Card.Body>
...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="sidebar-implementation">
      <ul>
